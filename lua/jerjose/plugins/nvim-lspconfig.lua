return {
    ...
    config = function()
        ...
        local on_attach = function(client, bufnr)
            ...
            vim.keymap.set({"n", "v"}, "gf", vim.lsp.buf.code_action, {
                buffer = bufnr,
        ...
        lspconfig["angularls"].setup({
            ...
            settings = {
                angular = {
                    fileWatcher = {
                        excludedDirs = {"**/node_modules", "**/dist", "**/build", "**/.cache", "**/.angular"}
                    },
                    experimental = {
                        ivy = true -- If using Ivy rendering engine
                    }
                }
            }
        })
        ...
        lspconfig.typos_lsp.setup({
            filetypes = {"markdown", "text", "gitcommit", "plaintext", "typescript", "html"}
        })

        lspconfig.emmet_language_server.setup({
          capabilities = capabilities,
          filetypes = { "css", "html", "sass", "scss", "typescriptreact" },
        })
